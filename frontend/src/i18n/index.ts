...
const dictionaries: Record<Locale, Dict> = {
  it: {
    ...
    'create.host.noResults': 'Nessun utente trovato: puoi scrivere il nome a mano.',
    ...
    'admin.users.confirmDelete': 'Eliminare {name} dagli utenti del portale? Perderà subito l\'accesso; se accede di nuovo verrà ricreato in stato "Da profilare".',
    ...
    'admin.sede.credentialMissing': 'Password del controller non configurata. Impostala qui sotto (viene salvata in Key Vault):',
    'admin.sede.password': 'Password controller',
    'admin.sede.passwordHelp': 'Conservata in Key Vault. Viene letta solo quando la mostri, e ogni lettura o modifica è registrata.',
    'admin.sede.passwordShow': 'Mostra password',
    'admin.sede.passwordHide': 'Nascondi password',
    'admin.sede.passwordEdit': 'Modifica password',
    'admin.sede.passwordNew': 'Nuova password',
    'admin.sede.passwordSave': 'Salva password',
    'admin.sede.passwordCancel': 'Annulla',
    'admin.sede.passwordConfirm': 'Salvare la nuova password della sede {code} in Key Vault? Deve essere già stata cambiata sul controller.',
    'admin.sede.passwordSaved': 'Password salvata in Key Vault e già in uso.',
    'admin.sede.newSedePasswordHint': 'La password si imposta dopo aver creato la sede.',
    'admin.wlc.reload': 'Ricarica configurazioni WLC',
    'admin.wlc.reloadResult': 'Password rilette da Key Vault: {loaded} caricate, {missing} mancanti, {failed} errori.',
  ...
  en: {
    ...
    'create.host.placeholder': 'Search by name, surname or email',
    'create.host.searching': 'Searching…',
    'create.host.noResults': 'No user found: you can type the name yourself.',
    ...
    'admin.users.confirmDelete': 'Remove {name} from the portal users? They lose access immediately; if they sign in again they come back awaiting approval.',
    ...
    'admin.sede.credentialMissing': 'Controller password not configured. Set it below (it is stored in Key Vault):',
    'admin.sede.password': 'Controller password',
    'admin.sede.passwordHelp': 'Kept in Key Vault. It is read only when you show it, and every read or change is logged.',
    'admin.sede.passwordShow': 'Show password',
    'admin.sede.passwordHide': 'Hide password',
    'admin.sede.passwordEdit': 'Change password',
    'admin.sede.passwordNew': 'New password',
    'admin.sede.passwordSave': 'Save password',
    'admin.sede.passwordCancel': 'Cancel',
    'admin.sede.passwordConfirm': 'Store the new password for site {code} in Key Vault? It must already have been changed on the controller.',
    'admin.sede.passwordSaved': 'Password stored in Key Vault and already in use.',
    'admin.sede.newSedePasswordHint': 'The password can be set once the site has been created.',
    'admin.wlc.reload': 'Reload WLC configuration',
    'admin.wlc.reloadResult': 'Passwords re-read from Key Vault: {loaded} loaded, {missing} missing, {failed} errors.',
