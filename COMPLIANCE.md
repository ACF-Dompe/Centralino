...
| Metrica | Valore |
|---|---|
| **Test unitari** | 477 conteggiati staticamente (169 frontend + 308 backend), di cui **93 nuovi** per i fix 5.8/5.9/5.10/9.1 e la deviazione D1 — da riconfermare con `make test` |
